...
pub async fn cancel_fine_tune(
    ...
    fine_tune_id: &str,
) -> Result<crate::models::FineTune, Error<CancelFineTuneError>> {
    ...
    let local_var_uri_str = format!(
        ...
        fine_tune_id = crate::apis::urlencode(fine_tune_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CancelFineTuneError> =
...
pub async fn create_answer(
    configuration: &configuration::Configuration,
    create_answer_request: crate::models::CreateAnswerRequest,
) -> Result<crate::models::CreateAnswerResponse, Error<CreateAnswerError>> {
    let local_var_configuration = configuration;
...
pub async fn create_classification(
    configuration: &configuration::Configuration,
    create_classification_request: crate::models::CreateClassificationRequest,
) -> Result<crate::models::CreateClassificationResponse, Error<CreateClassificationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateClassificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_completion(
    configuration: &configuration::Configuration,
    create_completion_request: crate::models::CreateCompletionRequest,
) -> Result<crate::models::CreateCompletionResponse, Error<CreateCompletionError>> {
    let local_var_configuration = configuration;
...
pub async fn create_edit(
    configuration: &configuration::Configuration,
    create_edit_request: crate::models::CreateEditRequest,
) -> Result<crate::models::CreateEditResponse, Error<CreateEditError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateEditError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_embedding(
    configuration: &configuration::Configuration,
    create_embedding_request: crate::models::CreateEmbeddingRequest,
) -> Result<crate::models::CreateEmbeddingResponse, Error<CreateEmbeddingError>> {
    let local_var_configuration = configuration;
...
pub async fn create_file(
    ...
    purpose: &str,
) -> Result<crate::models::OpenAiFile, Error<CreateFileError>> {
    let local_var_configuration = configuration;
...
pub async fn create_fine_tune(
    configuration: &configuration::Configuration,
    create_fine_tune_request: crate::models::CreateFineTuneRequest,
) -> Result<crate::models::FineTune, Error<CreateFineTuneError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFineTuneError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::ImagesResponse, Error<CreateImageError>> {
    let local_var_configuration = configuration;
...
pub async fn create_image_edit(
    configuration: &configuration::Configuration,
    _image: std::path::PathBuf,
    prompt: &str,
    _mask: Option<std::path::PathBuf>,
    n: Option<i32>,
    size: Option<&str>,
    response_format: Option<&str>,
    user: Option<&str>,
) -> Result<crate::models::ImagesResponse, Error<CreateImageEditError>> {
    let local_var_configuration = configuration;
...
pub async fn create_image_variation(
    ...
    response_format: Option<&str>,
    user: Option<&str>,
) -> Result<crate::models::ImagesResponse, Error<CreateImageVariationError>> {
    let local_var_configuration = configuration;
...
pub async fn create_moderation(
    configuration: &configuration::Configuration,
    create_moderation_request: crate::models::CreateModerationRequest,
) -> Result<crate::models::CreateModerationResponse, Error<CreateModerationError>> {
    let local_var_configuration = configuration;
...
pub async fn create_search(
    configuration: &configuration::Configuration,
    engine_id: &str,
    create_search_request: crate::models::CreateSearchRequest,
) -> Result<crate::models::CreateSearchResponse, Error<CreateSearchError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        engine_id = crate::apis::urlencode(engine_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSearchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_file(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<crate::models::DeleteFileResponse, Error<DeleteFileError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_model(
    configuration: &configuration::Configuration,
    model: &str,
) -> Result<crate::models::DeleteModelResponse, Error<DeleteModelError>> {
    let local_var_configuration = configuration;
...
pub async fn list_engines(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListEnginesResponse, Error<ListEnginesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListEnginesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_files(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListFilesResponse, Error<ListFilesError>> {
    let local_var_configuration = configuration;
...
pub async fn list_fine_tune_events(
    ...
    fine_tune_id: &str,
    stream: Option<bool>,
) -> Result<crate::models::ListFineTuneEventsResponse, Error<ListFineTuneEventsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFineTuneEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_fine_tunes(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListFineTunesResponse, Error<ListFineTunesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListFineTunesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_models(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListModelsResponse, Error<ListModelsError>> {
    let local_var_configuration = configuration;
...
pub async fn retrieve_engine(
    configuration: &configuration::Configuration,
    engine_id: &str,
) -> Result<crate::models::Engine, Error<RetrieveEngineError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveEngineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_file(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<crate::models::OpenAiFile, Error<RetrieveFileError>> {
    let local_var_configuration = configuration;
...
pub async fn retrieve_fine_tune(
    configuration: &configuration::Configuration,
    fine_tune_id: &str,
) -> Result<crate::models::FineTune, Error<RetrieveFineTuneError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveFineTuneError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_model(
    configuration: &configuration::Configuration,
    model: &str,
) -> Result<crate::models::Model, Error<RetrieveModelError>> {
    let local_var_configuration = configuration;
