# Rust API client for openai-openapi
...
Put the package under your project folder in a directory named `openai-openapi` and add the following to `Cargo.toml` under `[dependencies]`:

```
openai-openapi = { path = "./openai-openapi" }
```
